...
data <- read_csv("data/4th_grade_math_scale_scores_juris_all_students.csv", 
...
change |> 
  ...
  labs(y = "Score Change (2019 to 2022)",
       ...
       title = "Score change by Jurisdiction—4th Grade Mathematics")

ggsave("plots/4th_grade_math_all_students.png", bg = "white",
       w = 12, h = 12)
