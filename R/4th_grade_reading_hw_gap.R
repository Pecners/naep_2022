...
data <- read_csv("data/4th_grade_reading_scale_scores_juris.csv", 
...
gg |> 
  ...
  labs(y = "Gap Change (2019 to 2022)",
       ...
       title = "Hispanic-White gap change by Jurisdiction—4th Grade Reading")

ggsave("plots/4th_grade_reading_hw_gap.png", bg = "white")
